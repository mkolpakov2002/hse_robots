package ru.hse.control_system_v2.ui.widgets.joystick_view;
...
public class InnerCircleView extends View {
    ...
    /*
     * Interface called when innercricle or joystick_view point is moving and this interface will provide the
     * angle and strength
     * **/
     ...
     *  centerPoint which is mid point and both circle in joystick_view is making the ratio for their respective
     *  size
     * */
    @Override
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_DOWN -> handleMotion(event.getX(), event.getY());
            case MotionEvent.ACTION_MOVE -> handleMotionEvent(event.getX(), event.getY());
        }

        return true;
    }
    //Use some maths for make joystick_view working well
