...
//            List<DevicePrototype> devicesList = new ArrayList<>();
...
//
//            for (String s : array) {
//                DevicePrototype newBtDevice = new DevicePrototype(s);
//
...
//        }
    ...
    public void checkDeviceAddress(DevicePrototype devicePrototype) {
        DeviceItemType newDev = new DeviceItemType();
        String selectedDeviceInfo = devicePrototype.getName();
        String MAC, name;
...
//        App.setDevicesList(deviceItemTypeArrayList);
    ...
    @Override
    public void selectedDevice(DevicePrototype devicePrototype) {
