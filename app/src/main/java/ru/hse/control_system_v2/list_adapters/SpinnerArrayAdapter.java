...
public class SpinnerArrayAdapter<T> extends BaseAdapter implements Filterable, ThemedSpinnerAdapter {
     ...
     */
    public SpinnerArrayAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull T[] objects) {
    ...
    private SpinnerArrayAdapter(@NonNull Context context, @LayoutRes int resource,
    ...
    SpinnerArrayAdapter<CharSequence> createFromResource(@NonNull Context context,
                                                         @ArrayRes int textArrayResId, @LayoutRes int textViewResId) {
        final CharSequence[] strings = context.getResources().getTextArray(textArrayResId);
        return new SpinnerArrayAdapter<>(context, textViewResId, 0, Arrays.asList(strings), true);
    }
