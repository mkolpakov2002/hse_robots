package ru.hse.control_system_v2.schneewittchen.rosandroid.ui.fragments.main;
...
import ru.hse.control_system_v2.schneewittchen.rosandroid.viewmodel.MainViewModel;
...
public class MainFragment extends Fragment implements OnBackPressedListener {
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (tab.getText().toString()) {
                    case "Master" -> navController.navigate(R.id.action_to_masterFragment);
                    case "Details" -> navController.navigate(R.id.action_to_detailFragment);
                    case "SSH" -> navController.navigate(R.id.action_to_sshFragment);
                    default -> navController.navigate(R.id.action_to_vizFragment);
                }
            }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_main_ros, container, false);
    }
}
